  ...
  return (
        ...
        <footer className="bg-[#212731] dark:bg-gray-900 bottom-0 left-0 w-full border-t-2">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-200 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Vinayak</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 sm:justify-center sm:mt-0">
                    <a href="https://github.com/githvinayak" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
